			...
			<div class="row">
				<div class="span4">
					<form action="" method="POST" class="search_form">
						{{-- <input type="_token" name="hidden" value="{{ csrf_field() }}"> --}}
						...
						<ul class="thumbnails listing-products">
							<li class="span3">
								<div class="product-box">
									...
									<a href="product_detail.html" class="title">Woman</a><br/>
									<a href="#" class="category">Woman</a>
									<p class="price">$---</p>
								</div>
							</li>
							<li class="span3">
