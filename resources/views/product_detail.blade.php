    ...
    <body>
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">
				<div class="row">
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="themes/images/ladies/1.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="themes/images/ladies/woman1.jpg"></a>
											...
											<ul class="thumbnails listing-products">
												<li class="span3">
													<div class="product-box">
														...
														<a href="product_detail.html"><img alt="" src="themes/images/ladies/woman1.jpg"></a><br/>
					...
					<div class="span3 col">
						<div class="block">
							<ul class="nav nav-list">
								...
								<li><a href="/product">Flower</a></li>
								<li><a href="/product">Ladies</a></li>
							</ul>
							{{-- <br/>
			...
			<section id="copyright">
				<span>Copyright 2018 SEKALARASE Online Shop.
			</section>
</span>
			</section>
		</div>
